...
namespace KayBee4
{
    ...
    public class Bot : IBot
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KayBee4"/> class.
        /// </summary>
        ...
        public Bot(BotServices botServices, ConversationState conversationState, UserState userState, IBotTelemetryClient telemetryClient)
        {
            ...
            _dialogs = new DialogSet(_conversationState.CreateProperty<DialogState>(nameof(KayBee4)));
